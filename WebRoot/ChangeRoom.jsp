...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row" style="margin:50px 0 0 30px;">
			<div class="col-lg-12">				
					<form role="form" class="form-inline" method="post" action="ChangeRoom.jsp" >
						<fieldset>
							<div class="form-group">
								请输入身份证号：
								<input class="form-control RoomId" placeholder="身份证号" name="IDCard" type="text" >
							</div>
							<div class="form-group">
								<input class="form-control btn btn-primary chaxun"  type="submit" value="确定" >
							</div>
						</fieldset>
					</form>
			</div>
				...
				<% 					
						...
						out.print("<h3>当前可选的双人房有： ");
						Iterator it22 = room2.iterator();
						while(it22.hasNext())
							out.print(it22.next()+"  ");
						out.print("<h3>当前可选的三人房有： ");
						Iterator it33= room3.iterator();
						while(it33.hasNext())
							out.print(it33.    next()+"  ");
						out.println("</h3>");
						
					CustomerBean  customer = CustomerManage.selectByCIDCard(IDCard);
				%>
				</div>
				</div>
				...
				<div class="login-panel panel panel-default"  style="margin-top:80px;">
					...
					<div class="panel-body">
						<form role="form" method="post" action="ChangeRoom">
							<fieldset>
								
								<div class="form-group">
									姓名:<input class="form-control" placeholder="姓名" name="CName" type="text" value="<%=customer.getCName() %>">
								</div>
								<div class="form-group">
									性别:<input class="form-control" placeholder="性别" name="CSex" type="text" value="<%=customer.getCSex() %>">
								</div>
								<div class="form-group">
									身份证:<input class="form-control" placeholder="身份证" name="CIDCard" type="text" value="<%=customer.getCIDCard() %>">
								</div>
								<div class="form-group">
									房间号:<input class="form-control"  placeholder="房间号" name="RoomId" type="text" value="<%=customer.getRoomId() %>" >
								</div>
								<div class="form-group">
									新房间号:<input class="form-control"  placeholder="新房间号" name="nRoomId" type="text" value="" >
								</div>
								<div class="form-group">
									手机号:<input class="form-control" placeholder="手机号" name="CPhone" type="text" value="<%=customer.getCPhone() %>">
								</div>
...
//			 event.preventDefault(); 
		 	$(".huanfang").css("display","block");
//		 	var x = $(".RoomId").val();
//		 	$(".hidesheet").text($(".RoomId").val());
		 });
