<%@page import="com.hotel.bean.RoomBean"%>
...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row" style="margin:50px 0 0 30px;">
			<div class="col-lg-12">				
					<form role="form" class="form-inline" method="post" action="RoomChange.jsp" >
						<fieldset>
							<div class="form-group">
								请输入要修改的房间号：
								<input class="form-control " placeholder="房间号" name="RoomId" type="text" >
							</div>
							<div class="form-group">
			...
			<%
					...
					if(RoomId == null){
						...
						int nRoomId = Integer.parseInt(RoomId);
						RoomBean room  =RoomManage.selectByRoomId(nRoomId);
				%>
			...
			<div class="login-panel panel panel-default"  style="margin-top:80px;">
				...
				<div class="panel-body">
					<form role="form" method="post" action="RoomChange">
						<fieldset>
							<div class="form-group">
								<input class="form-control"  placeholder="房间号" name="RoomId" type="text" value="<%=room.getRoomId() %>" >
								<span class="help-block" style="color:red;">   上面这行会员号不能修改</span>
							</div>
							<div class="form-group">
								<input class="form-control" placeholder="房间大小" name="RoomSize" type="text" value="<%=room.getRoomSize() %>">
							</div>
							<div class="form-group">
								<input class="form-control" placeholder="房间价格" name="RoomPrice" type="text" value="<%=room.getRoomPrice() %>">
							</div>
							<div class="form-group">
								<input class="form-control" placeholder="剩余位数" name="IsEmp" type="text" value="<%=room.getIsEmp() %>">
							</div>
							<div class="form-group">
								<input class="form-control" placeholder="押金" name="Deposit" type="text" value="<%=room.getDeposit() %>">
							</div>
