...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<%
					ArrayList list = (ArrayList)VipcardManage.select();
				%>
				<table class="table table-striped">
  					<caption>VIP用户情况</caption>
					  <thead>
					    <tr>
					      <th>帐号</th>				
					      <th>姓名</th>
				 ...
				 <% 
					...
					while(it.hasNext()){
						VipcardBean vipcard = (VipcardBean)it.next();	
					
				%>
				
					    <tr>
					      <td><%=vipcard.getVIPId() %></td>
					      <td><%=vipcard.getVIPName() %></td>
					      <td><%=vipcard.getVIPSex() %></td>
					      <td><%=vipcard.getVIPIDCard() %></td>
					      <td><%=vipcard.getVIPPhone() %></td>
					      <td><%=vipcard.getVIPLevel() %></td>
					      <td><%=vipcard.getHandTime().toString() %></td>
					    </tr>
