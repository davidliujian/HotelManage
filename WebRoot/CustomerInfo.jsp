...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<%
					ArrayList list = (ArrayList)CustomerManage.selectCustomer();
				%>
				<table class="table table-striped">
  					<caption>当前住户情况</caption>
					  <thead>
					    <tr>
					      <th>订单号</th>				
					      <th>姓名</th>
				 ...
				 <% 
					...
					while(it.hasNext()){
						CustomerBean customer = (CustomerBean)it.next();	
					
				%>
				
					    <tr>
					      <td><%=customer.getOrderNum() %></td>
					      <td><%=customer.getCName() %></td>
					      <td><%=customer.getCSex() %></td>
					      <td><%=customer.getCIDCard() %></td>
					      <td><%=customer.getRoomId() %></td>
					      <td><%=customer.getCPhone() %></td>
					      <td><%=customer.getIsVip() %></td>
