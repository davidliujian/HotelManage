...
<html>
  ...
  <body>
	...
	<div style="margin-top:60px;">
		<form id="form4" action ="" style="text-align:center;">
			团&nbsp;号:<input type="text" id="SGId" name ="SGId"/><br/>
		...
		//	event.preventDefault();
			if(v==0){
				document.getElementById("form4").action="SGroupHandle";
			}else{
				document.getElementById("form4").action="SGroupFinish";
			}
		}
