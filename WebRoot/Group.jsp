...
<html>
  ...
  <body>
	...
	<div style="margin-top:60px;">
		<form id="form2" action ="" style="text-align:center;">
			<label for='GId'>团&nbsp;号:</label>
	...
	<script>
		...
		//	event.preventDefault();
			if(v==0){
				document.getElementById("form2").action="GroupHandle";
			}else{
				document.getElementById("form2").action="GroupFinish";
			}
		}
