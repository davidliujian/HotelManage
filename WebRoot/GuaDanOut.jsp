	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">挂单退房</li>
			</ol>
		</div>
		
		<div class="row" style="margin:50px 0 0 30px;">
			<div class="col-lg-12">				
					<form role="form" class="form-inline" method="post" action="GuaDanOut.jsp" >
						<fieldset>
							<div class="form-group">
								请输入要挂单的订单号：
		...
		<div class="col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default"  style="margin-top:200px;">
				...
				<div class="panel-body">
					<form role="form" method="post" action="GuaDanOut">
						<fieldset>
							<div class="form-group">
							...
							<div class="form-group">
								<input class="form-control btn btn-primary"  type="submit" value="确定挂单" style="width:50%;margin-left:25%;">
							</div>
